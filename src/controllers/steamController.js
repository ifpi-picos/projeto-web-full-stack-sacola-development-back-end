...
import { verifyIfUserExists } from '../utils/verifications.js';
import steam from "../services/steamApi/steam.js";
import { getSteamGridDbGameCover } from "../services/steamGridDb/steamgriddb.js";
    ...
    async addSteamGamesToDatabase(games) {
        try {
            ...
            for (let i = 0; i < steamGames.length; i++) {
                ...
                const gameDetails = await steam.getSteamGameById(steamGames[i].appid);
